...
class ActionLoadJson extends Action
{
  /**
  ...
  constructor(loadSaveManager)
  {
    ...
    this.content = {};
    this.content = this.loadSaveManager.params.toJson(this.content);
  ...
  {
    let oldContent = {};
    oldContent = this.loadSaveManager.params.toJson(oldContent);
    oldContent = this.loadSaveManager.layersManager.toJson(oldContent);

    this.loadSaveManager.initParamsFromData(this.content)
