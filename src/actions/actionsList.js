...
class ActionList
{
  ...
  checkActionPaint(layersManager)
  {
    ...
    if(!(this.actions[this.actions.length - 1] instanceof ActionPaint) && (!layersManager.selectedLayer.selectedZone || (this.actions.length > 0 && this.actions[this.actions.length - 1].targetZone != layersManager.selectedLayer.selectedZone) || (this.actions.length > 0 && layersManager.selectedLayer.selectedZone.geom == this.actions[this.actions.length - 1].geom)))
    {
      this.actions.pop();
    }
    else
